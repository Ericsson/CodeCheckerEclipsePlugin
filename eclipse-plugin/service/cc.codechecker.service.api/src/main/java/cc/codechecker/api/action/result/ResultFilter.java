...
public class ResultFilter {
    ...
    private final SearchRequest.Severity severity;
    ...
    public ResultFilter(Optional<String> filepath, Optional<String> checkerMsg, SearchRequest
    ...
    public SearchRequest.Severity getSeverity() {
        return severity;
    }
